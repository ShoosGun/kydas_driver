...
int main(int argc, char **argv)
{
    ...
    ros::Rate rate{25}; //25 hz is the optimal frequency to read/write to the driver without any information getting lost
    //Makes both drivers go at 1440 dps
    right_driver.speed_cmd = -1440.f * M_PI / 180; //assuming they are point outwards, we need to negate the right driver
